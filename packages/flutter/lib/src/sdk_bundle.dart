...
"use strict";var RetailcodeSDK=(()=>{var A=Object.defineProperty,Ee=Object.defineProperties,Ce=Object.getOwnPropertyDescriptor,Me=Object.getOwnPropertyDescriptors,$e=Object.getOwnPropertyNames,ie=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,Pe=Object.prototype.propertyIsEnumerable;var ne=(t,e,i)=>e in t?A(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,m=(t,e)=>{for(var i in e||(e={}))re.call(e,i)&&ne(t,i,e[i]);if(ie)for(var i of ie(e))Pe.call(e,i)&&ne(t,i,e[i]);return t},g=(t,e)=>Ee(t,Me(e));var He=(t,e)=>{for(var i in e)A(t,i,{get:e[i],enumerable:!0})},Oe=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of $e(e))!re.call(t,a)&&a!==i&&A(t,a,{get:()=>e[a],enumerable:!(r=Ce(e,a))||r.enumerable});return t};var Be=t=>Oe(A({},"__esModule",{value:!0}),t);var ze={};He(ze,{RetailcodeTopup:()=>he});var Re=Object.defineProperty,oe=Object.getOwnPropertySymbols,Ie=Object.prototype.hasOwnProperty,je=Object.prototype.propertyIsEnumerable,ae=(t,e,i)=>e in t?Re(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,se=(t,e)=>{for(var i in e||(e={}))Ie.call(e,i)&&ae(t,i,e[i]);if(oe)for(var i of oe(e))je.call(e,i)&&ae(t,i,e[i]);return t},h=class extends Error{constructor(t,e){super(t),this.status=e,this.name="RetailcodeApiError"}},De="https://corporateprodapi.retailcode.com.ng",le=class{constructor(t){this.publicKey=t,this.baseUrl=De}get authHeaders(){return{Authorization:`Bearer ${this.publicKey}`,Accept:"application/json"}}async fetchConfig(t){var e;let i=await fetch(`${this.baseUrl}/api/v1/auto-topup/public/config/${t}`,{headers:this.authHeaders});if(!i.ok)throw new h("Public API key is invalid or expired.",i.status);let r=await i.json();if(!r.success)throw new h((e=r.message)!=null?e:"Public API key is invalid or expired.");return r.data}async subscribeAirtime(t){var e;let r=await(await fetch(`${this.baseUrl}/api/v1/auto-topup/public/subscribe/airtime`,{method:"POST",headers:se({"Content-Type":"application/json"},this.authHeaders),body:JSON.stringify(t)})).json();if(!r.success)throw new h((e=r.message)!=null?e:"Subscription failed")}async subscribeData(t){var e;let r=await(await fetch(`${this.baseUrl}/api/v1/auto-topup/public/subscribe/data`,{method:"POST",headers:se({"Content-Type":"application/json"},this.authHeaders),body:JSON.stringify(t)})).json();if(!r.success)throw new h((e=r.message)!=null?e:"Subscription failed")}};function ce(t){let e=t.replace("#",""),i=e.length===3?e.split("").map(a=>a+a).join(""):e,r=parseInt(i,16);return{r:r>>16&255,g:r>>8&255,b:r&255}}function de(t,e){let{r:i,g:r,b:a}=ce(t),l=e>0?255:0,c=Math.abs(e)/100,u=f=>Math.min(255,Math.max(0,Math.round(f))).toString(16).padStart(2,"0");return"#"+u(i+(l-i)*c)+u(r+(l-r)*c)+u(a+(l-a)*c)}function k(t,e){let{r:i,g:r,b:a}=ce(t);return`rgba(${i},${r},${a},${e})`}function E(t){return t&&!["null","undefined",""].includes(String(t))?t:"#0057FF"}var Ne=/^(234[789][01]\d{8}|0[789][01]\d{8})$/;function pe(t){return Ne.test(t)}function ue(t){let e=t.replace(/\D/g,"");return e.length===11?e.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3"):t}function me(t,e,i){let r=parseFloat(t);return!isNaN(r)&&r>=e&&r<=i}var C=null;function fe(){return window.Swal?Promise.resolve():C||(C=new Promise(t=>{let e=document.createElement("link");e.rel="stylesheet",e.href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css",document.head.appendChild(e);let i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/sweetalert2@11",i.onload=()=>t(),document.head.appendChild(i)}),C)}function b(t){return window.Swal.fire(t)}function Y(t){let e=new URL(window.location.href);e.searchParams.set("status",t),window.history.replaceState({},"",e)}function M(t,e,i=!1){var c,u,f,p,v,x;let r=new URL(window.location.href);r.searchParams.set("isClose","true"),window.history.replaceState({},"",r),window.ReactNativeWebView||window.RetailcodeFlutter||(u=(c=window.webkit)==null?void 0:c.messageHandlers)!=null&&u.retailcode||(f=window.Android)!=null&&f.close||e==null||e(),t==null||t({closed:!0});let l=JSON.stringify({action:"close",success:i});window.ReactNativeWebView?window.ReactNativeWebView.postMessage(l):window.RetailcodeFlutter?window.RetailcodeFlutter.postMessage(l):(v=(p=window.webkit)==null?void 0:p.messageHandlers)!=null&&v.retailcode?window.webkit.messageHandlers.retailcode.postMessage({action:"close",success:i}):(x=window.Android)!=null&&x.close&&window.Android.close()}function ge(t,e){return{accent:t,accentHover:de(t,-10),accentFocus:k(t,.15),accentShadow:k(t,.25),fontFamily:e}}function q(t){return`
  ...
  `}var $=class{constructor(e){this.opts=e,this.client=new le(e.publicKey)}async mount(){var X;let{msisdn:e,container:i,onClose:r,theme:a={}}=this.opts,l=document.querySelector(i);if(!l)return;let c=E(a.accent),u=(X=a.fontFamily)!=null?X:"'DM Sans', system-ui, sans-serif",f=ge(c,u),p=null,v=n=>{let o=`
        <div style="font-family:${u};padding:24px;border:1.5px solid #FCA5A5;background:#FEF2F2;border-radius:8px;color:#991B1B;text-align:center;max-width:440px;margin:40px auto;">
        ...
        </div>`;p?p.innerHTML=o:l.innerHTML=o};if(!pe(e)){v("Subscriber phone number is not valid.");return}p=l.attachShadow({mode:"open"}),this.renderSpinner(p,f);let x;try{x=await this.client.fetchConfig(e)}catch(n){let o=n instanceof h?n.message:"Could not connect to the activation server.";v(o);return}p.innerHTML="",await fe();let{name:be="",subscribedAirtime:S=!1,subscribedData:F=!1,airtimethresholds:ve={},airtimeMin:P=0,airtimeMax:H=1e4,dataThresholds:xe={},dataPlans:we=[],terms:O=null}=x,B=S&&F,ye=(S||F)&&!B;if(!S&&!F&&O&&!(await b({title:"Terms & Conditions",html:`
          <div style="text-align:left;font-size:13px;line-height:1.65;color:#374151;font-family:${u};">
            ${typeof O=="string"?O.replace(/\n/g,"<br>"):""}
          </div>`,confirmButtonText:"I Agree & Continue",confirmButtonColor:c,showCancelButton:!0,cancelButtonText:"Decline",cancelButtonColor:"#9CA3AF",allowOutsideClick:!1,allowEscapeKey:!1,reverseButtons:!0,didOpen:o=>{let d=o.querySelector(".swal2-html-container");d&&(d.style.maxHeight="50vh",d.style.overflowY="auto",d.style.setProperty("-webkit-overflow-scrolling","touch"),d.style.touchAction="pan-y",d.style.overscrollBehavior="contain",d.style.textAlign="left",d.style.padding="0 1.6em")}})).isConfirmed){M(r);return}let Te=Object.entries(ve).map(([n,o])=>`<option value="${o}">Below \u20A6${n}</option>`).join(""),ke=Object.entries(xe).map(([n,o])=>`<option value="${o}">Below ${n}</option>`).join(""),Se=we.map(n=>`<option value="${n.productId}">${n.allowance} \u2014 \u20A6${n.price}</option>`).join(""),R=document.createElement("div");R.className="rc-modal",R.innerHTML=this.buildModalHtml({tokens:f,msisdn:e,prefilledName:be,airtimeMin:P,airtimeMax:H,airtimeOptions:Te,dataOptions:ke,dataPlanOptions:Se}),p.appendChild(R);let s=n=>p.getElementById(n),J=s("rc-type-select"),w=s("section-airtime"),L=s("section-data"),I=s("rc-main-title"),j=s("rc-desc"),y=s("rc-submit"),D=s("field-msisdn"),N=s("rc-dependent-link-wrap"),z=s("section-dependent-controls"),V=s("group-type-selector"),_=s("row-beneficiary"),Fe=s("row-spending"),Le=s("field-airtime-max"),Ae=s("field-data-max"),W=!1,U=()=>{let n=B||W,o=J.value;n?(I.innerText="Add Dependent",j.innerText="Configure subscription for someone else",D.classList.remove("hidden"),_.style.gridTemplateColumns="1fr 1fr",V.classList.remove("hidden"),N.classList.add("hidden"),z.classList.remove("hidden"),w.classList.toggle("hidden",o==="data"),L.classList.toggle("hidden",o==="airtime"),Le.classList.toggle("hidden",o==="data"),Ae.classList.toggle("hidden",o==="airtime"),Fe.style.gridTemplateColumns=o==="both"?"1fr 1fr":"1fr"):ye?(I.innerText="Complete Profile",j.innerText="Finish your Auto Topup subscription",D.classList.add("hidden"),_.style.gridTemplateColumns="1fr",V.classList.add("hidden"),N.classList.remove("hidden"),z.classList.add("hidden"),w.classList.toggle("hidden",S),L.classList.toggle("hidden",F)):(I.innerText="Auto Topup Subscription",j.innerText="Automate your airtime & data recharge",D.classList.add("hidden"),_.style.gridTemplateColumns="1fr",V.classList.remove("hidden"),N.classList.add("hidden"),z.classList.add("hidden"),w.classList.toggle("hidden",o==="data"),L.classList.toggle("hidden",o==="airtime"))};U();let G=()=>{p.innerHTML=""};J.addEventListener("change",U),s("rc-close").addEventListener("click",()=>M(r,G)),s("rc-switch-to-dep").addEventListener("click",n=>{n.preventDefault(),W=!0,s("rc-name").value="",U()}),s("rc-name").addEventListener("input",n=>{let o=n.target;o.value=o.value.replace(/[^a-zA-Z\s]/g,"")}),["rc-msisdn-input","airtimeTopupValue","rc-airtime-max","rc-data-max"].forEach(n=>{var o;(o=s(n))==null||o.addEventListener("input",d=>{let T=d.target;T.value=T.value.replace(/\D/g,"")})}),p.querySelectorAll(".rc-field input, .rc-field select").forEach(n=>{let o=()=>n.closest(".rc-field").classList.toggle("has-val",n.value!=="");n.addEventListener("input",o),n.addEventListener("change",o),o()}),y.addEventListener("click",async()=>{var Z,Q;let n=K=>{var ee,te;return(te=(ee=s(K))==null?void 0:ee.value.trim())!=null?te:""},o=B||W,d=o?n("rc-msisdn-input"):e;if(!w.classList.contains("hidden")&&!me(n("airtimeTopupValue"),P,H)){b({icon:"warning",title:"Invalid Amount",text:`Enter \u20A6${P} \u2013 \u20A6${H}.`,confirmButtonColor:c});return}if(o&&!d){b({icon:"warning",title:"Wait!",text:"Enter the dependent phone number.",confirmButtonColor:c});return}y.disabled=!0,y.innerText="Processing\u2026";let T={network:"MTN",msisdn:d,name:n("rc-name")};try{w.classList.contains("hidden")||await this.client.subscribeAirtime(m(g(m({},T),{airtimeThresholdId:n("airtimeThresholdId"),airtimeTopupValue:n("airtimeTopupValue")}),o&&{customerMsisdn:e,monthlyMaximum:n("rc-airtime-max")})),L.classList.contains("hidden")||await this.client.subscribeData(m(g(m({},T),{dataThresholdId:n("dataThresholdId"),dataTopupValue:n("dataTopupValue")}),o&&{customerMsisdn:e,monthlyMaximum:n("rc-data-max")})),Y("successful"),(Q=(Z=this.opts).onSuccess)==null||Q.call(Z,{success:!0}),b({icon:"success",title:"Subscription Active!",text:"Your auto top-up is now enabled.",confirmButtonColor:c,didClose:()=>M(r,G,!0)})}catch(K){Y("failed"),b({icon:"error",title:"Oops!",text:K.message,confirmButtonColor:c}),y.disabled=!1,y.innerText="Activate Subscription"}})}renderSpinner(e,i){var a,l;let r=document.createElement("div");r.innerHTML=`
      <style>
    ...
    `}};var he={create(t){var i;let e=new $(g(m({},t),{theme:g(m({},t.theme),{accent:E((i=t.theme)==null?void 0:i.accent)})}));return{mount:()=>e.mount()}}};return Be(ze);})();
```;
