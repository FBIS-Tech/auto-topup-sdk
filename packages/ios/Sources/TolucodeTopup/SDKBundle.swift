...
let kRetailcodeSdkBundle = #"""
"use strict";var RetailcodeSDK=(()=>{var A=Object.defineProperty,Ce=Object.defineProperties,Ee=Object.getOwnPropertyDescriptor,Me=Object.getOwnPropertyDescriptors,$e=Object.getOwnPropertyNames,ie=Object.getOwnPropertySymbols;var re=Object.prototype.hasOwnProperty,Pe=Object.prototype.propertyIsEnumerable;var ne=(t,e,i)=>e in t?A(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,u=(t,e)=>{for(var i in e||(e={}))re.call(e,i)&&ne(t,i,e[i]);if(ie)for(var i of ie(e))Pe.call(e,i)&&ne(t,i,e[i]);return t},f=(t,e)=>Ce(t,Me(e));var He=(t,e)=>{for(var i in e)A(t,i,{get:e[i],enumerable:!0})},Oe=(t,e,i,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let a of $e(e))!re.call(t,a)&&a!==i&&A(t,a,{get:()=>e[a],enumerable:!(r=Ee(e,a))||r.enumerable});return t};var Re=t=>Oe(A({},"__esModule",{value:!0}),t);var ze={};He(ze,{RetailcodeTopup:()=>he});var Be=Object.defineProperty,oe=Object.getOwnPropertySymbols,Ie=Object.prototype.hasOwnProperty,je=Object.prototype.propertyIsEnumerable,ae=(t,e,i)=>e in t?Be(t,e,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[e]=i,se=(t,e)=>{for(var i in e||(e={}))Ie.call(e,i)&&ae(t,i,e[i]);if(oe)for(var i of oe(e))je.call(e,i)&&ae(t,i,e[i]);return t},g=class extends Error{constructor(t,e){super(t),this.status=e,this.name="RetailcodeApiError"}},De="https://corporatedevapi.retailcode.com.ng",le=class{constructor(t,e){this.publicKey=t,this.baseUrl=e!=null?e:De}get authHeaders(){return{Authorization:`Bearer ${this.publicKey}`,Accept:"application/json"}}async fetchConfig(t){var e;let i=await fetch(`${this.baseUrl}/api/v1/auto-topup/public/config/${t}`,{headers:this.authHeaders});if(!i.ok)throw new g("Public API key is invalid or expired.",i.status);let r=await i.json();if(!r.success)throw new g((e=r.message)!=null?e:"Public API key is invalid or expired.");return r.data}async subscribeAirtime(t){var e;let r=await(await fetch(`${this.baseUrl}/api/v1/auto-topup/public/subscribe/airtime`,{method:"POST",headers:se({"Content-Type":"application/json"},this.authHeaders),body:JSON.stringify(t)})).json();if(!r.success)throw new g((e=r.message)!=null?e:"Subscription failed")}async subscribeData(t){var e;let r=await(await fetch(`${this.baseUrl}/api/v1/auto-topup/public/subscribe/data`,{method:"POST",headers:se({"Content-Type":"application/json"},this.authHeaders),body:JSON.stringify(t)})).json();if(!r.success)throw new g((e=r.message)!=null?e:"Subscription failed")}};function ce(t){let e=t.replace("#",""),i=e.length===3?e.split("").map(a=>a+a).join(""):e,r=parseInt(i,16);return{r:r>>16&255,g:r>>8&255,b:r&255}}function de(t,e){let{r:i,g:r,b:a}=ce(t),l=e>0?255:0,c=Math.abs(e)/100,p=m=>Math.min(255,Math.max(0,Math.round(m))).toString(16).padStart(2,"0");return"#"+p(i+(l-i)*c)+p(r+(l-r)*c)+p(a+(l-a)*c)}function T(t,e){let{r:i,g:r,b:a}=ce(t);return`rgba(${i},${r},${a},${e})`}function C(t){return t&&!["null","undefined",""].includes(String(t))?t:"#0057FF"}var Ne=/^(234[789][01]\d{8}|0[789][01]\d{8})$/;function pe(t){return Ne.test(t)}function ue(t){let e=t.replace(/\D/g,"");return e.length===11?e.replace(/(\d{4})(\d{3})(\d{4})/,"$1 $2 $3"):t}function me(t,e,i){let r=parseFloat(t);return!isNaN(r)&&r>=e&&r<=i}var E=null;function fe(){return window.Swal?Promise.resolve():E||(E=new Promise(t=>{let e=document.createElement("link");e.rel="stylesheet",e.href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css",document.head.appendChild(e);let i=document.createElement("script");i.src="https://cdn.jsdelivr.net/npm/sweetalert2@11",i.onload=()=>t(),document.head.appendChild(i)}),E)}function h(t){return window.Swal.fire(t)}function Y(t){let e=new URL(window.location.href);e.searchParams.set("status",t),window.history.replaceState({},"",e)}function M(t,e,i=!1){var c,p,m,d,b,v;let r=new URL(window.location.href);r.searchParams.set("isClose","true"),window.history.replaceState({},"",r),window.ReactNativeWebView||window.RetailcodeFlutter||(p=(c=window.webkit)==null?void 0:c.messageHandlers)!=null&&p.retailcode||(m=window.Android)!=null&&m.close||e==null||e(),t==null||t({closed:!0});let l=JSON.stringify({action:"close",success:i});window.ReactNativeWebView?window.ReactNativeWebView.postMessage(l):window.RetailcodeFlutter?window.RetailcodeFlutter.postMessage(l):(b=(d=window.webkit)==null?void 0:d.messageHandlers)!=null&&b.retailcode?window.webkit.messageHandlers.retailcode.postMessage({action:"close",success:i}):(v=window.Android)!=null&&v.close&&window.Android.close()}function ge(t,e){return{accent:t,accentHover:de(t,-10),accentFocus:T(t,.15),accentShadow:T(t,.25),fontFamily:e}}function J(t){return`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .rc-submit-btn:hover:not(:disabled) { background: ${t.accentHover}; transform: translateY(-1px); box-shadow: 0 6px 18px ${T(t.accent,.35)}; }
    ...
    .rc-spinner-ring {
      ...
      border: 4px solid ${T(t.accent,.18)};
  ...
  `}var $=class{constructor(e){this.opts=e,this.client=new le(e.publicKey,e.baseUrl)}async mount(){var X;let{msisdn:e,container:i,onClose:r,theme:a={}}=this.opts,l=document.querySelector(i);if(!l)return;let c=C(a.accent),p=(X=a.fontFamily)!=null?X:"'DM Sans', system-ui, sans-serif",m=ge(c,p),d=null,b=n=>{let o=`
        <div style="font-family:${p};padding:24px;border:1.5px solid #FCA5A5;background:#FEF2F2;border-radius:8px;color:#991B1B;text-align:center;max-width:440px;margin:40px auto;">
        ...
        </div>`;d?d.innerHTML=o:l.innerHTML=o};if(!pe(e)){b("Subscriber phone number is not valid.");return}d=l.attachShadow({mode:"open"}),this.renderSpinner(d,m);let v;try{v=await this.client.fetchConfig(e)}catch(n){let o=n instanceof g?n.message:"Could not connect to the activation server.";b(o);return}d.innerHTML="",await fe();let{name:be="",subscribedAirtime:k=!1,subscribedData:S=!1,airtimethresholds:ve={},airtimeMin:P=0,airtimeMax:H=1e4,dataThresholds:xe={},dataPlans:we=[],terms:O=null}=v,R=k&&S,ye=(k||S)&&!R;if(!k&&!S&&O&&!(await h({title:"Terms & Conditions",html:`
          ...
          </div>`,confirmButtonText:"I Agree & Continue",confirmButtonColor:c,showCancelButton:!0,cancelButtonText:"Decline",cancelButtonColor:"#9CA3AF",allowOutsideClick:!1,allowEscapeKey:!1,reverseButtons:!0})).isConfirmed){M(r);return}let Te=Object.entries(ve).map(([n,o])=>`<option value="${o}">Below \u20A6${n}</option>`).join(""),ke=Object.entries(xe).map(([n,o])=>`<option value="${o}">Below ${n}</option>`).join(""),Se=we.map(n=>`<option value="${n.productId}">${n.allowance} \u2014 \u20A6${n.price}</option>`).join(""),B=document.createElement("div");B.className="rc-modal",B.innerHTML=this.buildModalHtml({tokens:m,msisdn:e,prefilledName:be,airtimeMin:P,airtimeMax:H,airtimeOptions:Te,dataOptions:ke,dataPlanOptions:Se}),d.appendChild(B);let s=n=>d.getElementById(n),q=s("rc-type-select"),x=s("section-airtime"),F=s("section-data"),I=s("rc-main-title"),j=s("rc-desc"),w=s("rc-submit"),D=s("field-msisdn"),N=s("rc-dependent-link-wrap"),z=s("section-dependent-controls"),V=s("group-type-selector"),_=s("row-beneficiary"),Fe=s("row-spending"),Le=s("field-airtime-max"),Ae=s("field-data-max"),U=!1,W=()=>{let n=R||U,o=q.value;n?(I.innerText="Add Dependent",j.innerText="Configure subscription for someone else",D.classList.remove("hidden"),_.style.gridTemplateColumns="1fr 1fr",V.classList.remove("hidden"),N.classList.add("hidden"),z.classList.remove("hidden"),x.classList.toggle("hidden",o==="data"),F.classList.toggle("hidden",o==="airtime"),Le.classList.toggle("hidden",o==="data"),Ae.classList.toggle("hidden",o==="airtime"),Fe.style.gridTemplateColumns=o==="both"?"1fr 1fr":"1fr"):ye?(I.innerText="Complete Profile",j.innerText="Finish your Auto Topup subscription",D.classList.add("hidden"),_.style.gridTemplateColumns="1fr",V.classList.add("hidden"),N.classList.remove("hidden"),z.classList.add("hidden"),x.classList.toggle("hidden",k),F.classList.toggle("hidden",S)):(I.innerText="Auto Topup Subscription",j.innerText="Automate your airtime & data recharge",D.classList.add("hidden"),_.style.gridTemplateColumns="1fr",V.classList.remove("hidden"),N.classList.add("hidden"),z.classList.add("hidden"),x.classList.toggle("hidden",o==="data"),F.classList.toggle("hidden",o==="airtime"))};W();let G=()=>{d.innerHTML=""};q.addEventListener("change",W),s("rc-close").addEventListener("click",()=>M(r,G)),s("rc-switch-to-dep").addEventListener("click",n=>{n.preventDefault(),U=!0,s("rc-name").value="",W()}),s("rc-name").addEventListener("input",n=>{let o=n.target;o.value=o.value.replace(/[^a-zA-Z\s]/g,"")}),["rc-msisdn-input","airtimeTopupValue","rc-airtime-max","rc-data-max"].forEach(n=>{var o;(o=s(n))==null||o.addEventListener("input",L=>{let y=L.target;y.value=y.value.replace(/\D/g,"")})}),d.querySelectorAll(".rc-field input, .rc-field select").forEach(n=>{let o=()=>n.closest(".rc-field").classList.toggle("has-val",n.value!=="");n.addEventListener("input",o),n.addEventListener("change",o),o()}),w.addEventListener("click",async()=>{var Z,Q;let n=K=>{var ee,te;return(te=(ee=s(K))==null?void 0:ee.value.trim())!=null?te:""},o=R||U,L=o?n("rc-msisdn-input"):e;if(!x.classList.contains("hidden")&&!me(n("airtimeTopupValue"),P,H)){h({icon:"warning",title:"Invalid Amount",text:`Enter \u20A6${P} \u2013 \u20A6${H}.`,confirmButtonColor:c});return}if(o&&!L){h({icon:"warning",title:"Wait!",text:"Enter the dependent phone number.",confirmButtonColor:c});return}w.disabled=!0,w.innerText="Processing\u2026";let y={network:"MTN",msisdn:L,name:n("rc-name")};try{x.classList.contains("hidden")||await this.client.subscribeAirtime(u(f(u({},y),{airtimeThresholdId:n("airtimeThresholdId"),airtimeTopupValue:n("airtimeTopupValue")}),o&&{customerMsisdn:e,monthlyMaximum:n("rc-airtime-max")})),F.classList.contains("hidden")||await this.client.subscribeData(u(f(u({},y),{dataThresholdId:n("dataThresholdId"),dataTopupValue:n("dataTopupValue")}),o&&{customerMsisdn:e,monthlyMaximum:n("rc-data-max")})),Y("successful"),(Q=(Z=this.opts).onSuccess)==null||Q.call(Z,{success:!0}),h({icon:"success",title:"Subscription Active!",text:"Your auto top-up is now enabled.",confirmButtonColor:c,didClose:()=>M(r,G,!0)})}catch(K){Y("failed"),h({icon:"error",title:"Oops!",text:K.message,confirmButtonColor:c}),w.disabled=!1,w.innerText="Activate Subscription"}})}renderSpinner(e,i){var a,l;let r=document.createElement("div");r.innerHTML=`
      <style>
    ...
    `}};var he={create(t){var i;let e=new $(f(u({},t),{theme:f(u({},t.theme),{accent:C((i=t.theme)==null?void 0:i.accent)})}));return{mount:()=>e.mount()}}};return Re(ze);})();
"""#
